...
export default function FlipbookHero({ isLoading, images }) {
 ...
 <div className={`mobile-hero-overlay md:hidden absolute inset-0 z-30 flex items-center justify-center pointer-events-none transition-all md:duration-[800ms] will-change-[transform,opacity] ${textFold === 0 ? 'max-md:duration-300 opacity-100 translate-y-0 scale-100' : 'max-md:duration-75 opacity-0 scale-[0.92]'}`}>
